...
class PiMediaCenter:
    ...
    def draw_player_ui(self, draw):
        ...
        # Prev
        self.draw_button(draw, 70, btn_y, 50, 40, "l<", bg_color="#45475a") 
        # Play/Pause
        ...
        # Next
        self.draw_button(draw, 200, btn_y, 50, 40, ">l", bg_color="#45475a")
        # Vol +
        self.draw_button(draw, 260, btn_y + 5, 40, 30, "+", bg_color="#313244")

        # Nút Back nhỏ góc trên
        self.draw_button(draw, WIDTH - 50, 30, 40, 20, "ESC", bg_color=WARN_COLOR, text_color="black", icon_font=font_sm)
        ...
        # --- TRÌNH PHÁT NHẠC (MUSIC PLAYER UI) ---
            ...
            if y > 170:
                if x < 60: # Vol -
                    ...
                    pygame.mixer.music.set_volume(self.volume)
                elif x < 120: # Prev (Đơn giản là replay hoặc prev trong list nếu làm logic list)
                    ...
                    if self.is_paused:
                     ...
                     # Logic Next bài tiếp theo (ví dụ đơn giản)
                     pass
                else: # Vol +
